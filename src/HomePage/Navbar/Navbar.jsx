        ...
        <div>
            <div style={{ backgroundColor: "#32aeb1", }} >
                <div style={{ display: "flex", alignItems: "center", width: "80%", margin: "auto", justifyContent: "space-between", padding: "16px 0px 16px" }}>
                    ...
                    <button style={{ backgroundColor: "transparent", border: "none", display: "flex", alignItems: "center", fontSize: "14px" }}>
                        <img src="https://www.netmeds.com/assets/gloryweb/images/icons/cart_icon.svg" alt="cart" />
                        <b style={{color:"white"}}>Cart</b>
                    </button>
                    <button style={{ backgroundColor: "transparent", border: "none", display: "flex", alignItems: "center", fontSize: "14px" }}>
                        <img src="https://www.netmeds.com/assets/gloryweb/images/icons/profile_icon.svg" alt="sign in" />
                        <b style={{color:"white"}}>Sign in / Sign up</b>
                    </button>
                </div>
                <div style={{ display: "flex", alignItems: "center", width: "70%", margin: "auto", justifyContent: "space-between", padding: "0px 0px 16px" }}>
                    <button style={{ backgroundColor: "transparent", border: "none", display: "flex", alignItems: "center", fontSize: "14px",gap:"4px"}}>
                        <img src="https://www.netmeds.com/assets/version1667495847/gloryweb/images/icons/medicine.svg" alt="Medicine" />
                        <b >Medicine</b>
                    </button>
                    <button style={{ backgroundColor: "transparent", border: "none", display: "flex", alignItems: "center", fontSize: "14px" ,gap:"4px"}}>
            ...
            <div style={{ display: "flex", alignItems: "center", width: "70%", margin: "auto", justifyContent: "space-between", padding: "0px 0px 16px", fontSize:"16px",marginTop:"10px"}}>
